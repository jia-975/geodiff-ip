...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, help='path for config')
    parser.add_argument('--w_ip', type=float, default=0.0,
                    help='weight for global gradients')
    ...
    # Logging
    output_dir = get_new_log_dir(log_dir, "ip_%f"%(args.w_ip), tag=args.tag)
